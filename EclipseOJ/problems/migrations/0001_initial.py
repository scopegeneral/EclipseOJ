    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter', models.CharField(max_length=1, validators=[django.core.validators.RegexValidator(b'^[A-Z]$', b'Only a captial letter is allowed.')], verbose_name=b'Problem ID')),
